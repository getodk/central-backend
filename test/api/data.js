...
module.exports = {
  instances: {
    simple: {
      one: instance('simple', 'one', '<orx:meta><orx:instanceID>one</orx:instanceID></orx:meta><name>Alice</name><age>30</age>'),
      two: instance('simple', 'two', '<orx:meta><orx:instanceID>two</orx:instanceID></orx:meta><name>Bob</name><age>34</age>'),
      three: instance('simple', 'three', '<orx:meta><orx:instanceID>three</orx:instanceID></orx:meta><name>Chelsea</name><age>38</age>')
    },
    withrepeat: {
