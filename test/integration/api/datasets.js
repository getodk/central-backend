  ...
  <manifest xmlns="http://openrosa.org/xforms/xformsManifest">
    <mediaFile type="entityList">
      ...
      it('should override blob and link dataset', testService(async (service, { Forms, FormAttachments, Audits, Datasets }) => {
        ...
        const form = await Forms.getByProjectAndXmlFormId(1, 'withAttachments', false, Form.NoDefRequired).then((o) => o.get());
        ...
        service.login('alice', (asAlice) =>
          asAlice.post('/v1/projects/1/forms')
            ...
            .then(() => asAlice.post('/v1/projects/1/forms/withAttachments/draft/attachments/goodone.csv')
              ...
              .expect(200))
            .then(() => Promise.all([
              Forms.getByProjectAndXmlFormId(1, 'withAttachments', false, Form.NoDefRequired).then((o) => o.get()),
