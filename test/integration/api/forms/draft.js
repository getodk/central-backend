  ...
  describe('/:id/draft', () => {
    ...
    describe('/publish POST', () => {
      ...
      it('should log the correct def ids in the form audit log', testService(async (service, { Forms }) => {
        ...
        const formT1 = await Forms.getByProjectAndXmlFormId(1, 'simple2', Form.PublishedVersion).then((o) => o.get());
        ...
        const formT4 = await Forms.getByProjectAndXmlFormId(1, 'simple2', Form.PublishedVersion).then((o) => o.get());
    ...
    describe('/attachments', () => {
      ...
      describe('/:name POST', () => {
        ...
        it('should upload form definition and form attachment with cookie auth', testService(async (service) => {
          ...
          await service.get('/v1/projects/1/forms/withAttachments/draft.xml')
            .set('Cookie', `session=${token}`)
            .set('X-Forwarded-Proto', 'https')
            .then(({ text }) => {
