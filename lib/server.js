...
const models = require('./model/package')(db);
...
require('./resources/users')(service, models);
require('./resources/sessions')(service, models);
require('./resources/forms')(service, models);
