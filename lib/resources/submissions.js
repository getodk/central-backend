...
module.exports = (service, endpoint) => {
        ...
        .then((partial) => project.getFormByXmlFormId(partial.xmlFormId)
          ...
          .then((form) => Submission.getById(form.id, partial.instanceId, QueryOptions.extended)
            ...
            .then((maybeExtant) => maybeExtant
              ...
              // submission and the expected attachments, then log audits for any
              // attachments that actually get populated:
  ...
  service.post('/projects/:projectId/forms/:id/submissions', endpoint(({ Audit, Project, SubmissionAttachment, SubmissionPartial }, { params, body, auth }) =>
    Project.getById(params.projectId)
      .then(getOrNotFound)
      .then((project) => auth.canOrReject('submission.create', project)
