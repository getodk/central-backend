        ...
        .then((partial) => getForm(auth, params, partial.xmlFormId, Forms, partial.def.version)
          ...
          .then((form) => {
            ...
            if (deprecatedId != null) {
              ...
              return Submissions.getAnyDefByProjectAndInstanceId(form.id, deprecatedId, draft)
                .then(getOrReject(Problem.user.deprecatedIdNotFound({ deprecatedId })))
                .then((deprecated) => {
                  if (deprecated.current !== true) throw Problem.user.deprecatingOldSubmission({ deprecatedId });
                  return Promise.all([
            ...
            return Submissions.getAnyDefByProjectAndInstanceId(form.id, partial.instanceId, draft)
              .then((maybeExtant) => {
