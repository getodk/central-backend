...
module.exports = (service, endpoint) => {
  ...
  service.get('/projects/:projectId/forms/:id/submissions.csv.zip', endpoint(({ Project, SubmissionAttachment, SubmissionVersion }, { params, auth }, _, response) =>
    Project.getById(params.projectId)
      .then(getOrNotFound)
      .then((project) => auth.canOrReject('submission.read', project)
        ...
        .then((form) => Promise.all([
          SubmissionVersion.streamForExport(form.id),
