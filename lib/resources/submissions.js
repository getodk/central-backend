...
module.exports = (service, endpoint) => {
  ...
  const openRosaSubmission = (path, getForm) => {
      ...
      resolve(Option.of(files).map((xs) => xs.find((file) => file.fieldname === 'xml_submission_file')))
        ...
        .then((partial) => getForm(params.projectId, partial.xmlFormId, Form)
          .then((form) => Promise.all([
            ...
            Submission.getById(form.id, partial.instanceId, QueryOptions.extended),
  ...
  openRosaSubmission('/projects/:projectId/submission', (projectId, xmlFormId, Form) =>
