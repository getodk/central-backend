...
// As of January 2025, this is the current recommended flow.
// See: https://datatracker.ietf.org/doc/html/rfc9700#name-best-practices
...
module.exports = (service, __, anonymousEndpoint) => {
  ...
  service.get('/oidc/callback', anonymousEndpoint.html(async (container, _, req, res) => {
    try {
      ...
      // Per https://openid.net/specs/openid-connect-core-1_0.html#rfc.section.3.1.3.3
      const idTokenExpected = true;

      const tokens = await authorizationCodeGrant(oidcConfig, requestUrl, { pkceCodeVerifier, expectedState, idTokenExpected });
