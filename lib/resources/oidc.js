...
module.exports = (service, endpoint) => {
  ...
  service.get('/oidc/login', endpoint.html(async ({ Sentry }, _, req, res) => {
    try {
      ...
      // State is not strictly required because PKCE (code_challenge) protects us from CSRF attacks.
      ...
      // back to us.  If it doesn't explicitly get one, it sends back an empty string.
