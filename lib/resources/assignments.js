...
module.exports = (service, endpoint) => {
  ...
  service.post('/projects/:id/assignments/:roleId/:actorId', endpoint(({ Actor, Project, Role }, { auth, params }) =>
    Promise.all([
      Project.getById(params.id).then(getOrNotFound),
      getRoleByParam(Role, params.roleId).then(getOrNotFound),
      Actor.getById(params.actorId).then(getOrNotFound)
  ...
  service.delete('/projects/:id/assignments/:roleId/:actorId', endpoint(({ Actor, Project, Role }, { auth, params }) =>
    Promise.all([
      Project.getById(params.id).then(getOrNotFound),
      getRoleByParam(Role, params.roleId).then(getOrNotFound),
      Actor.getById(params.actorId).then(getOrNotFound)
