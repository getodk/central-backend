...
module.exports = (service, endpoint) => {
  ...
  service.get('/projects/:projectId/formList', endpoint.openRosa(({ Project, env }, { auth, params, originalUrl, queryOptions }) =>
    Project.getById(params.projectId)
      .then(getOrNotFound)
      .then((project) => (auth.actor().isEmpty() ? reject(Problem.user.openRosaAuthenticationRequired()) : project))
      .then((project) => project.getFormsByAuthForOpenRosa(auth, queryOptions.allowArgs('formID')))
