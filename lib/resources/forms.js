...
module.exports = (service, endpoint, anonymousEndpoint) => {
  ...
  service.post('/projects/:projectId/forms/:xmlFormId/restore', endpoint(async ({ Forms, Datasets, Audits }, { auth, params }) => {
    const form = await Forms.getByProjectAndNumericId(params.projectId, params.xmlFormId, Form.WithoutDef, Form.ExcludeXml, QueryOptions.none, true)
      .then(getOrNotFound);
