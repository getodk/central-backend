...
module.exports = (service, endpoint) => {
  ...
  service.get('/projects/:projectId/forms', endpoint(({ Forms, Projects }, { auth, params, query, queryOptions }) =>
    Projects.getById(params.projectId)
      ...
      .then((project) => Forms.getByProjectId(auth, project.id, false, Form.AnyVersion, queryOptions, isTrue(query.deleted)))));
  ...
  service.delete('/projects/:projectId/forms/:id/draft', endpoint(({ Audits, Forms, Submissions }, { params, auth }) =>
    Forms.getByProjectAndXmlFormId(params.projectId, params.id, false, Form.NoDefRequired)
      .then(getOrNotFound)
      .then((form) => auth.canOrReject('form.update', form))
  ...
  service.get('/projects/:projectId/forms/:id', endpoint(({ Forms }, { auth, params, queryOptions }) =>
    Forms.getByProjectAndXmlFormId(params.projectId, params.id, false, Form.AnyVersion, queryOptions ?? QueryOptions.none)
      .then(getOrNotFound)
      .then(ensureDef)
      .then((form) => canReadForm(auth, form))));
  ...
  service.get('/projects/:projectId/forms/:id/versions/:version', endpoint(({ Forms }, { auth, params, queryOptions }) =>
    Forms.getByProjectAndXmlFormId(params.projectId, params.id, false, params.version, queryOptions ?? QueryOptions.none)
      .then(getOrNotFound)
      .then(ensureDef)
      .then((form) => canReadForm(auth, form))));
  ...
  service.get('/projects/:projectId/forms/:id/draft', endpoint(({ Forms }, { auth, params, queryOptions }) =>
    Forms.getByProjectAndXmlFormId(params.projectId, params.id, false, Form.DraftVersion, queryOptions ?? QueryOptions.none)
      .then(getOrNotFound)
      .then(ensureDef)
      .then((form) => canReadForm(auth, form))));
  ...
  service.patch('/projects/:projectId/forms/:id', endpoint(({ Forms }, { auth, params, body }) =>
    Forms.getByProjectAndXmlFormId(params.projectId, params.id, false, Form.NoDefRequired)
      ...
      .then(() => Forms.getByProjectAndXmlFormId(params.projectId, params.id, false, Form.AnyVersion))
      .then(getOrNotFound)
      .then(ensureDef)));
  ...
  service.post('/projects/:projectId/forms/:id/restore', endpoint(({ Forms }, { auth, params }) =>
    Forms.getByProjectAndNumericId(params.projectId, params.id, false, Form.NoDefRequired, QueryOptions.none, true)
      .then(getOrNotFound)
