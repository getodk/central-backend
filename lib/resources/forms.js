...
module.exports = (service, endpoint) => {
  ...
  service.post('/projects/:projectId/forms/:id/draft', endpoint(({ Forms, Keys, Projects, Submissions }, { params, auth }, request) =>
    Promise.all([
      ...
      Forms.getByProjectAndXmlFormId(params.projectId, params.id, Form.DraftVersion).then(getOrNotFound)
    ])
      .then(([ project, form ]) => auth.canOrReject('form.update', form)
        .then(() => ((request.is('*/*') === false) // false only if no request body.
          ? Forms.getByProjectAndXmlFormId(params.projectId, params.id, Form.PublishedVersion, Form.IncludeXml)
            .then(getOrNotFound)
  ...
  service.post('/projects/:projectId/forms/:id/draft/publish', endpoint(({ Forms, Submissions }, { params, auth, query }) =>
    Forms.getByProjectAndXmlFormId(params.projectId, params.id, Form.DraftVersion, Form.IncludeXml)
      .then(getOrNotFound)
      ...
      .then((form) => (isPresent(query.version)
        ...
        ? setVersion(form.xml, query.version)
          ...
          .then(() => Forms.getByProjectAndXmlFormId(params.projectId, params.id, Form.DraftVersion))
          .then(getOrNotFound)
        : resolve(form)))
  ...
  service.delete('/projects/:projectId/forms/:id/draft', endpoint(({ Audits, Forms, Submissions }, { params, auth }) =>
    Forms.getByProjectAndXmlFormId(params.projectId, params.id, Form.WithoutDef)
      .then(getOrNotFound)
      .then((form) => auth.canOrReject('form.update', form))
  ...
  formResource('/projects/:projectId/forms/:id', (Forms, params, withXml = Form.WithoutXml, options = QueryOptions.none) =>
    Forms.getByProjectAndXmlFormId(params.projectId, params.id, Form.PublishedVersion, withXml, options)
      .then(getOrNotFound)
      .then(ensureDef));
  service.get('/projects/:projectId/forms/:id', endpoint(({ Forms }, { auth, params, queryOptions }) =>
    Forms.getByProjectAndXmlFormId(params.projectId, params.id, Form.AnyVersion, Form.WithoutXml, queryOptions ?? QueryOptions.none)
      .then(getOrNotFound)
      .then(ensureDef)
      .then((form) => canReadForm(auth, form))));

  formResource('/projects/:projectId/forms/:id/versions/:version', (Forms, params, withXml = false, options = QueryOptions.none) =>
    Forms.getByProjectAndXmlFormId(params.projectId, params.id, params.version, withXml, options)
      .then(getOrNotFound)
      .then(ensureDef));
  service.get('/projects/:projectId/forms/:id/versions/:version', endpoint(({ Forms }, { auth, params, queryOptions }) =>
    Forms.getByProjectAndXmlFormId(params.projectId, params.id, params.version, Form.WithoutXml, queryOptions ?? QueryOptions.none)
      .then(getOrNotFound)
      .then(ensureDef)
      .then((form) => canReadForm(auth, form))));

  formResource('/projects/:projectId/forms/:id/draft', (Forms, params, withXml = Form.WithoutXml, options = QueryOptions.none) =>
    Forms.getByProjectAndXmlFormId(params.projectId, params.id, Form.DraftVersion, withXml, options)
      .then(getOrNotFound)
      .then(ensureDef));
  service.get('/projects/:projectId/forms/:id/draft', endpoint(({ Forms }, { auth, params, queryOptions }) =>
    Forms.getByProjectAndXmlFormId(params.projectId, params.id, Form.DraftVersion, Form.WithoutXml, queryOptions ?? QueryOptions.none)
      .then(getOrNotFound)
      .then(ensureDef)
      .then((form) => canReadForm(auth, form))));
  ...
  service.patch('/projects/:projectId/forms/:id', endpoint(({ Forms }, { auth, params, body }) =>
    Forms.getByProjectAndXmlFormId(params.projectId, params.id, Form.WithoutDef)
      ...
      .then(() => Forms.getByProjectAndXmlFormId(params.projectId, params.id, Form.AnyVersion))
      .then(getOrNotFound)
      .then(ensureDef)));
  ...
  service.post('/projects/:projectId/forms/:id/restore', endpoint(({ Forms }, { auth, params }) =>
    Forms.getByProjectAndNumericId(params.projectId, params.id, Form.WithoutDef, Form.ExcludeXml, QueryOptions.none, true)
      .then(getOrNotFound)
  ...
  service.get('/test/:key/projects/:projectId/forms/:id/draft/attachments/:name', endpoint((container, { params }, request, response) => {
    ...
    return Forms.getByProjectAndXmlFormId(params.projectId, params.id, Form.DraftVersion)
      .then(getOrNotFound)
      .then(ensureDef)
      .then(checkFormToken(params.key))
