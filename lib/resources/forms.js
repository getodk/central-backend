...
module.exports = (service, endpoint, anonymousEndpoint) => {
  ...
  service.patch('/projects/:projectId/forms/:xmlFormId/draft', endpoint(async ({ Forms }, { auth, params, body }) => {
    const form = await Forms.getByProjectAndXmlFormId(params.projectId, params.xmlFormId, Form.DraftVersion)
      .then(getOrNotFound);
    ...
    await Forms.updateDef(form, form.def, defFromRequest);
  ...
  service.patch('/projects/:projectId/forms/:xmlFormId', endpoint(({ Forms }, { auth, params, body }) =>
    Forms.getByProjectAndXmlFormId(params.projectId, params.xmlFormId, Form.AnyVersion)
      ...
      .then((form) => auth.canOrReject('form.update', form))
      .then((form) => Promise.all([
        Forms.update(form, Form.fromApi(body)),
        Forms._updateDef(form.def, Form.Def.fromApi(body))
      ]))
