...
module.exports = (service, endpoint, anonymousEndpoint) => {
  ...
  formResource('/projects/:projectId/forms/:id', (Forms, params, withXml = false, options = QueryOptions.none) =>
    Forms.getByProjectAndXmlFormId(params.projectId, params.id, Form.PublishedVersion, Form.withXml(withXml), options)
      .then(getOrNotFound)
      .then(ensureDef));
  ...
  formResource('/projects/:projectId/forms/:id/versions/:version', (Forms, params, withXml = false, options = QueryOptions.none) =>
    Forms.getByProjectAndXmlFormId(params.projectId, params.id, params.version, Form.withXml(withXml), options)
      .then(getOrNotFound)
      .then(ensureDef));
  ...
  formResource('/projects/:projectId/forms/:id/draft', (Forms, params, withXml = false, options = QueryOptions.none) =>
    Forms.getByProjectAndXmlFormId(params.projectId, params.id, Form.DraftVersion, Form.withXml(withXml), options)
      .then(getOrNotFound)
      .then(ensureDef));
  ...
  service.get('/form-links/:enketoId/form', endpoint(({ Forms }, { params, auth }) =>
    Forms.getByEnketoId(params.enketoId)
      .then(getOrNotFound)
      .then((form) => canReadForm(auth, form))));
