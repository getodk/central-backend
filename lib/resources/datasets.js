...
module.exports = (service, endpoint) => {
  ...
  service.delete('/projects/:projectId/datasets/:name/properties/:propertyName', endpoint(async ({ Datasets, Entities }, { params, auth }) => {
    ...
    if (property.aux.forms.length > 0) throw Problem.user.formDependentOnTheProperty(property.forms);
    ...
    if (entitiesWithDataInProperty.totalCount > 0) throw Problem.user.dataExistsForTheProperty({ propertyName: property.name, entities: entitiesWithDataInProperty.data });
