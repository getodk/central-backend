      ...
      getForm(Forms, auth, params)
        .then((form) => {
          ...
          return Promise.all([
            ...
            Submissions.streamForExport(form.id, draft, undefined, options) // Node16 upgrade: streaming promise has to be last in the array, I don't understand the reason.
          ])
            .then(([ fields, count, stream]) =>
