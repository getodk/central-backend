...
module.exports = (service) => {
  ...
  service.get(singleRowRegex, odataEndpoint.json(({ Form, Submission, env }, { auth, params, query, originalUrl }) =>
  ...
  // serves table data.
  service.get('/forms/:id.svc/:table', odataEndpoint.json(({ all, Form, Submission, env }, { auth, params, originalUrl, query }) =>
    Form.getByXmlFormId(params.id)
      .then(getOrNotFound)
      .then((form) => auth.canOrReject('read', form)
