...
module.exports = (service, endpoint) => {
  ...
  service.get('/projects/:projectId/datasets/:name/entities', endpoint(async ({ Datasets, Entities }, { params, auth, queryOptions }) =>
    Datasets.get(params.projectId, params.name)
      ...
      .then((dataset) => auth.canOrReject('entity.list', dataset)
        .then(() => Entities.getByDataset(dataset.id, queryOptions)))));

  service.get('/projects/:id/datasets/:name/entities2', endpoint(async ({ Projects }, { params, queryOptions, query }) => {
  ...
  service.get('/projects/:projectId/datasets/:name/entities/:uuid', endpoint(({ Datasets, Entities }, { params, auth, queryOptions }) =>
    Datasets.get(params.projectId, params.name)
      .then(getOrNotFound)
      .then((dataset) => auth.canOrReject('entity.read', dataset)
        .then(() => Entities.getByUuidWithDef(dataset.id, params.uuid, queryOptions))
        .then(getOrNotFound))));

  service.get('/projects/:id/datasets/:name/entities2/:uuid', endpoint(async ({ Projects }, { params, queryOptions }) => {
  ...
  service.put('/projects/:projectId/datasets/:name/entities/:uuid', endpoint(({ Datasets, Entities }, { params, auth, body }) =>
    Datasets.get(params.projectId, params.name)
      .then(getOrNotFound)
      .then((dataset) => auth.canOrReject('entity.list', dataset)
        .then(() => Entities.getByUuidWithDef(dataset.id, params.uuid, QueryOptions.extended))
        .then(getOrNotFound)
        .then((entity) => Entities.createVersion(body, entity)))));

  service.put('/projects/:id/datasets/:name/entities2/:uuid', endpoint(async ({ Projects }, { params, queryOptions, body, headers }) => {
