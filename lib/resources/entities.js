...
module.exports = (service, endpoint) => {
  ...
  service.get('/projects/:projectId/datasets/:name/entities/:uuid/geojson', endpoint(async ({ Datasets, Entities, GeoExtracts }, { params, auth }) => {
    ...
    return GeoExtracts.getEntityFeatureCollectionGeoJson(dataset.id, [params.uuid]);
  }));
