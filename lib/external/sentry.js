...
function withTracing(jobName, fn) {
  if (typeof fn !== 'function') throw new Error('Should be called on a function.');
...
module.exports = { Sentry, sanitizeEventRequest, isSensitiveEndpoint, filterTokenFromUrl, withTracing };
