...
pg.Pool = function(_cfg) {
  ...
  if(PGSSLROOTCERT) {
    if(!cfg.ssl) throw new Error('Incompatible values for env vars: PGSSLMODE, PGSSLROOTCERT.');
    cfg.ssl.ca = readFileSync(PGSSLROOTCERT);
  }

  console.log('Creating pool with:', cfg);
