...
const versionJoinCondition = (version, enketoId) => {
  if (enketoId) {
    if (version != null) throw new Error(`Should not provide both enketoId and version; got: ${JSON.stringify({ enketoId, version })}`);
    return sql`
  ...
  else if (version === Form.NoDefRequired)    return sql`FALSE`; // eslint-disable-line no-multi-spaces
