...
select client_audits.*, blobs.content from submission_defs
  inner join
    (select id, "submitterId", "createdAt" from submissions
      where "formId"=${formId} and draft=${draft} and "deletedAt" is not null) as submissions
    on submissions.id=submssion_defs."submissionId"
  inner join
...
module.exports = { create, existsForBlob, streamForExport };
