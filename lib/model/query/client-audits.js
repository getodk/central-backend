...
select client_audits.*, blobs.s3_status, blobs.content, blobs.sha, blobs.md5, submissions."instanceId", "localKey", "keyId", index, submissions."instanceId" from submission_defs
  inner join
