...
module.exports = {
  ...
  getAll: (options) => ({ simply, Project }) =>
    simply.getWhere('projects', { deletedAt: null }, Project),
  getById: (id, options) => ({ simply, Project }) =>
    simply.getOneWhere('projects', { id, deletedAt: null }, Project),
