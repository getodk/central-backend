...
const projectMetrics = () => (({ Analytics }) => runSequentially([
  ...
  for (const row of entityForms) {
    const project = _getProject(projects, row.projectId);
    project.forms.num_entity_create_forms = row.num_entity_create_forms;
    project.forms.num_repeat_entity_create_forms = row.num_repeat_entity_create_forms;
    project.forms.num_entity_update_forms = row.num_entity_update_forms;
    project.forms.num_repeat_entity_update_forms = row.num_repeat_entity_update_forms;
    project.forms.num_entity_create_update_forms = row.num_entity_create_update_forms;
  }
