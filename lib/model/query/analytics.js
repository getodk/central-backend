...
const previewMetrics = () => (({ Analytics }) => Promise.all([
  ...
  // TODO for 2023.4: set these values
  // metrics.system.num_client_audit_attachments.[recent|total]
  // metrics.system.num_client_audit_attachments_unprocessed.[recent|total]
  // metrics.system.num_client_audit_attachments_processed.[recent|total]
