...
const actionCondition = (action) => {
  if (action === 'nonverbose')
    ...
    return sql`action in ('user.create', 'user.update', 'user.delete', 'user.assignment.create', 'user.assignment.delete')`;
  else if (action === 'field_key')
    return sql`action in ('field_key.create', 'field_key.assignment.create', 'field_key.assignment.delete', 'field_key.session.end')`;
  else if (action === 'public_link')
    return sql`action in ('public_link.create', 'public_link.assignment.create', 'public_link.assignment.delete', 'public_link.session.end')`;
