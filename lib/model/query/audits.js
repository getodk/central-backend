...
const actionCondition = (action) => {
  if (action === 'nonverbose')
    ...
    return sql`action not in ('entity.create', 'entity.create.error', 'entity.update.version', 'submission.create', 'submission.update', 'submission.update.version', 'submission.attachment.update', 'backup', 'analytics')`;
  else if (action === 'user')
    ...
    return sql`action in ('entity.create', 'entity.create.error', 'entity.update.version')`;
