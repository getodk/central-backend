...
const _get = extender(Audit)(Actor.alias('actor_actor', 'actorActor'), Option.of(Actor), Option.of(Form), Option.of(FormDef), Option.of(Project))((fields, extend, options) => sql`
select * from audits
