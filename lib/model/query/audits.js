...
const actionCondition = (action) => {
  if (action === 'nonverbose')
    ...
    return sql`action in ('user.create', 'user.update', 'user.delete', 'user.assignment.create', 'user.assignment.delete', 'user.session.create', 'user.preference.update', 'user.preference.delete')`;
    ...
    return sql`action in ('dataset.create', 'dataset.update', 'entity.bulk.delete', 'entity.bulk.restore')`;
