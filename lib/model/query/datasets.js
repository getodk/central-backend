...
const _trashedFilter = (force, datasetId, projectId, datasetName) => {
  ...
  if (datasetId) idFilters.push(sql`datasets."id" = ${datasetId}`);
...
const purge = (force = false, projectId = null, datasetName = null, datasetId = null) => ({ oneFirst, run }) => {
  ...
  return oneFirst(sql`
    WITH redacted_audits AS (
      ...
      FROM datasets
      WHERE ${_trashedFilter(force, datasetId, projectId, datasetName)}
      ...
      AND ${_trashedFilter(force, datasetId, projectId, datasetName)}
