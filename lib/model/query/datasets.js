...
// Purging steps
// 1. Log the purge in the audit log
// 2. Make entity tombstones for entities in datasets to be purged (including previously deleted entities)
// 3. Update actees table for the specific form to leave some useful information behind
// 4. Delete the datasets and their resources from the database
const purge = (force = false, projectId = null, datasetName = null, datasetId = null,) => ({ oneFirst, run }) => {
  ...
  return oneFirst(sql`
    WITH redacted_audits AS (
      ...
      USING datasets, submission_defs sd
