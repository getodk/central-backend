...
writeSiteProperty.audit = (userId, propertyName) => (log) =>
  log('user.preference.update', null, { site: propertyName });
...
writeProjectProperty.audit = (userId, projectId, propertyName) => (log) =>
  log('user.preference.update', null, { project: propertyName });
...
removeSiteProperty.audit = (userId, propertyName) => (log) =>
  log('user.preference.delete', null, { site: propertyName });
...
removeProjectProperty.audit = (userId, projectId, propertyName) => (log) =>
  log('user.preference.delete', null, { project: propertyName });
