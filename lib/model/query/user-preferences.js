...
writeSiteProperty.audit = (actor, propertyName) => (log) =>
  log('user.preference.update', actor, { site: propertyName });
...
writeProjectProperty.audit = (actor, projectId, propertyName) => (log) =>
  log('user.preference.update', actor, { project: propertyName });
...
removeSiteProperty.audit = (actor, propertyName) => (log) =>
  log('user.preference.delete', actor, { site: propertyName });
...
removeProjectProperty.audit = (actor, projectId, propertyName) => (log) =>
  log('user.preference.delete', actor, { project: propertyName });
