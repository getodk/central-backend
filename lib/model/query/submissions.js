...
const { blankStringToNull, construct, truncateString, applyPipe, prepandString } = require('../../util/util');
...
const createNew = (partial, form, deviceIdIn = null, userAgentIn = null, odkClient = null) => ({ one, context }) => {
  ...
  const userAgent = applyPipe(userAgentIn, prepandString(odkClient), truncateString(255), blankStringToNull);
