...
const getAnyDefByProjectAndInstanceId = (formId, instanceId, draft = false) => ({ maybeOne }) => maybeOne(sql`
select submission_defs.* from submission_defs
inner join
...
module.exports = {
  ...
  getCurrentDefBySubmissionId, getCurrentDefByIds, getAnyDefByProjectAndInstanceId,
