...
const _get = extender(Assignment)(Actor)((fields, options, extend) => sql`
...
const _getForForms = extender(Assignment, Assignment.FormSummary)(Actor, Form)((fields, options, extend) => sql`
select ${fields} from assignments
