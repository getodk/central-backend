...
_grant.audit = (actor, roleId, acteeId) => (log) => ((actor.type === 'singleUse')
  ? null
  : log('assignment.create', actor, { roleId, grantedActeeId: acteeId }));

// TODO/SL: i bet we can remove all of this flexi shit
...
_revoke.audit = (actor, roleId, acteeId) => (log) => log('assignment.delete', actor, { roleId, revokedActeeId: acteeId });
