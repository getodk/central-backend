...
const grantSystem = (actor, systemName, actee) => ({ one, Assignments, Roles }) =>
...
module.exports = {
  assignRole, assignSystemRole, unassignRole, canAssignRole,
  can,
  getForFormsByProjectId, getForFormsByProjectAndRoleId, deleteByActorId, deleteByActeeId
};
