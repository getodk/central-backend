...
// version of ensure() which allows setting status - should only be used in tests
const _ensureWithStatus = (blob) => ({ oneFirst }) => oneFirst(sql`
with ensured as
...
module.exports = {
  ensure, getById, purgeUnattached, _ensureWithStatus,
