...
injector.withDefaults = (base, { queries, instances } = {}) => {
  const defaultQueries = {
    ...
    formDefs: require('./query/form-defs'),
    ...
    submissionDefs: require('./query/submission-defs'),
  ...
  const defaultInstances = {
    ...
    ClientAudit: require('./instance/client-audit'),
    ...
    FormDef: require('./instance/form-def'),
    FormField: require('./instance/form-field'),
    FormPartial: require('./instance/form-partial'),
    Key: require('./instance/key'),
    Project: require('./instance/project'),
    PublicLink: require('./instance/public-link'),
    ...
    SubmissionDef: require('./instance/submission-def'),
