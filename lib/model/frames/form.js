...
const DraftAndPublishedVersion = Symbol('draft and published version');
...
class Form extends Frame.define(
  ...
  /** Latest draft and published version if available */
  static get DraftAndPublishedVersion() { return DraftAndPublishedVersion; }
