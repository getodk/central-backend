...
const up = async (db) => {
  await db.raw(`
    CREATE INDEX idx_fk_actors_acteeId ON "actors" ("acteeId");
    ...
    CREATE INDEX idx_fk_dataset_form_defs_formDefId ON "dataset_form_defs" ("formDefId");
    ...
    CREATE INDEX idx_fk_entity_def_sources_auditId ON "entity_def_sources" ("auditId");
    CREATE INDEX idx_fk_entity_def_sources_submissionDefId ON "entity_def_sources" ("submissionDefId");
    CREATE INDEX idx_fk_entity_submission_backlog_auditId ON "entity_submission_backlog" ("auditId");
    CREATE INDEX idx_fk_entity_submission_backlog_submissionDefId ON "entity_submission_backlog" ("submissionDefId");
    CREATE INDEX idx_fk_entity_submission_backlog_submissionId ON "entity_submission_backlog" ("submissionId");
    ...
    CREATE INDEX idx_fk_forms_acteeId ON "forms" ("acteeId");
    CREATE INDEX idx_fk_forms_currentDefId ON "forms" ("currentDefId");
    CREATE INDEX idx_fk_forms_draftDefId ON "forms" ("draftDefId");
    CREATE INDEX idx_fk_forms_projectId ON "forms" ("projectId");
    CREATE INDEX idx_fk_projects_keyId ON "projects" ("keyId");
