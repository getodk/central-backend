            ...
            SELECT
                EXISTS (
                    ...
                    WHERE
                        ...
                        l.locktype = 'advisory'
                        AND l.objsubid = 1
                        AND ((l.classid::bigint << 32) | l.objid::bigint) = hash_text_to_bigint(pg_current_xact_id_if_assigned ()::text, 'submissions-eventstamp-lock')
                ) as lockfound,
...
--- sign: get_event ---
COMMENT ON FUNCTION "public"."get_event"() IS '{"dbsamizdat": {"version": 1, "definition_hash": "b510e2aa9078b5750dc656a09f28e676"}}';
