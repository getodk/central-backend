...
module.exports = Instance.with(ActeeTrait('form_attachment'))('form_attachments', {
  all: [ 'definitionId', 'blobId', 'name', 'type', 'acteeId' ],
  readable: [ 'name', 'type' ],
  extended: [ 'definitionId', 'blobId', 'name', 'type', 'updatedAt' ]
  ...
  static getByFormAndName(definitionId, name) {
    return simply.getOneWhere('form_attachments', { definitionId, name }, FormAttachment);
  }
  static getAllByDefinitionId(definitionId, options) {
    return formAttachments.getAllByDefinitionId(definitionId, options);
  }
  static getAllByDefinitionIdForOpenRosa(definitionId) {
    return formAttachments.getAllByDefinitionIdForOpenRosa(definitionId);
  }
});
