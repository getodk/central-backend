...
module.exports = Instance('form_attachments', {
  ...
  readable: [ 'name', 'type', 'updatedAt' ]
})(({ FormAttachment, formAttachments, simply }) => class {

  create() { return simply.create('form_attachments', this); }
  ...
  static getAllByFormDefId(formDefId) {
    return formAttachments.getAllByFormDefId(formDefId);
  }
