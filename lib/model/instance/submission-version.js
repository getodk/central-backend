...
module.exports = Instance('submission_versions', {
  all: [ 'id', 'submissionId', 'xml', 'xformId', 'actorId', 'createdAt' ],
  ...
  // it has the SubmissionVersion as the base object, with submission: Submission
  // and submitter: Actor properties upon it.
  static getForExport(formId, instanceId) {
    return submissionVersions.getForExport(formId, instanceId);
  }
  static streamForExport(formId, options) {
    return submissionVersions.streamForExport(formId, options);
  }
});
