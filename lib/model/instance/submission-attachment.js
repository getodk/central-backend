...
module.exports = Instance('submission_attachments', {
  ...
  static createAll(attachments) { return submissionAttachments.createAll(attachments); }
  ...
  static streamForExport(formId, keyIds) { return submissionAttachments.streamForExport(formId, keyIds); }
});
