...
module.exports = Instance('submission_defs', {
  all: [ 'id', 'submissionId', 'xml', 'instanceName', 'formDefId', 'submitterId', 'localKey', 'encDataAttachmentName', 'signature', 'createdAt' ],
  readable: [ 'id', 'xml', 'instanceName', 'submitterId', 'createdAt' ]
