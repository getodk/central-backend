...
module.exports = Instance.with(ChildTrait('Actor'))('field_keys', {
  all: [ 'actorId', 'createdBy' ],
  readable: [ 'createdBy', 'lastUsed' ], // TODO/refactor: lastUsed is extended
  writable: []
  ...
  forApi() {
    ...
    // TODO: deal with token, createdBy extended metadata?
    ...
    return mergeAll([ pick(FieldKey.fields.readable, this), this.actor.forApi(), { token, createdBy } ]);
  }
