...
const ExtendedForm = ExtendedInstance({
  ...
  forApi() {
    ...
    return merge(superproto(this).forApi(), { createdBy, submissions, enketoId });
  }
});
...
module.exports = Instance.with(
  ...
  forApi() {
    ...
    const enketoId =
      ...
      : undefined;
    /* eslint-enable indent */
    return mergeAll([ this.def.forApi(), readable, { enketoId } ]);
  }
  ...
  publish() {
    ...
    return Promise.all([
      this.with({ currentDefId: this.draftDefId, draftDefId: null, enketoSingleId: null }).update(),
