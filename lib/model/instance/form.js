...
const ExtendedForm = ExtendedInstance({
  fields: {
    joined: [ 'submissions', 'lastSubmission', 'xlsContentType' ],
    readable: [ 'projectId', 'xmlFormId', 'state', 'name', 'createdAt', 'updatedAt', 'submissions', 'lastSubmission', 'xlsContentType' ] // createdBy and submissions are manually incorporated by forApi()
  },
  forApi() {
...
const ExtendedFormVersion = ExtendedInstance({
  fields: {
    joined: [ 'xlsContentType' ],
    readable: [ 'projectId', 'xmlFormId', 'state', 'name', 'createdAt', 'updatedAt', 'xlsContentType' ]
  },
  forApi() {
    // TODO: send back, eg, hasPublished, hasDraft?
