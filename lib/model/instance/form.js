...
const ExtendedForm = ExtendedInstance({
  fields: {
    ...
    readable: [ 'projectId', 'xmlFormId', 'state', 'name', 'enketoId', 'createdAt', 'updatedAt', 'submissions', 'lastSubmission', 'excelContentType' ] // createdBy and submissions are manually incorporated by forApi()
  },
  forApi() {
...
module.exports = Instance.with(
  ...
  all: [ 'id', 'projectId', 'xmlFormId', 'state', 'name', 'currentDefId', 'draftDefId',
    'enketoId', 'acteeId', 'createdAt', 'updatedAt', 'deletedAt' ],
  readable: [ 'projectId', 'xmlFormId', 'state', 'name', 'enketoId', 'createdAt', 'updatedAt' ],
  writable: [ 'name', 'state' ]
