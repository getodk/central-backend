...
module.exports = Instance.with(
  ...
  setManagedEncryption(key, suffix) {
    ...
    return injectPublicKey(this.def.xml, key.public)
      ...
      .then((xml) => FormPartial.fromXml(xml))
      // supply the full key instance with id to preëmpt round-trip. TODO: awkward Option.
