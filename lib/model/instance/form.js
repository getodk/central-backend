...
module.exports = Instance.with(ActeeTrait)('forms', {
  all: [ 'id', 'xmlFormId', 'xml', 'version', 'state', 'hash', 'name', 'acteeId',
    'createdAt', 'updatedAt', 'deletedAt' ],
  readable: [ 'xmlFormId', 'xml', 'version', 'state', 'hash', 'name', 'createdAt', 'updatedAt', 'submissions', 'lastSubmission' ], // TODO/refactor: submissions and lastSubmission are extended
  writable: [ 'name', 'state' ]
  ...
  forApi() {
    ...
    const additional = (this.createdBy != null)
      ...
      : {};
    return merge(pick(Form.fields.readable, this), additional);
  }
  ...
  static getAllForOpenRosa() { return forms.getAllForOpenRosa(); }
