...
// sentinel value used below (oh how i long for case classes..)
const DraftVersion = {};
...
module.exports = Instance.with(
  ...
  setManagedKey(key, suffix) {
    ...
    return injectPublicKey(this.def.xml, key.public)
      ...
      .then((partial) => partial.createVersion(this, true));
  }
  ...
  publish() {
    ...
    return Promise.all([
      ...
      this.def.with({ publishedAt: new Date() }).update()
  ...
  getVersions() { return forms.getVersions(this.id); }
