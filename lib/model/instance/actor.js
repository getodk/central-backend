...
module.exports = Instance('actors', {
  ...
  //
  // also we need to possibly fetch additional acteeIds, for app users and public
  // links to be manipulable by project staff.
  acteeIds() {
    return actors.extraActeeIdsFor(this)
      .then((extra) => [ this.acteeId, this.type, '*' ].concat(extra));
  }
