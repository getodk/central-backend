...
const actorTypes = { system: 'system', user: 'user', group: 'group', proxy: 'proxy', singleUse: 'singleUse' };
...
module.exports = Instance.with(ActeeTrait)(({ Grant, actors, all, grants, simply }) => class {
  ...
  forApi() { return this.without('acteeId', 'deletedAt', 'expiresAt', 'systemId', 'type'); }
  ...
  static getBySystemId(systemId) { return simply.getOneWhere('actors', { systemId }, this); }
