...
module.exports = Instance.with(ActeeTrait)('actors', {
  all: [ 'id', 'type', 'acteeId', 'displayName', 'meta', 'createdAt', 'updatedAt',
    'deletedAt', 'systemId' ],
  readable: [ 'id', 'type', 'displayName', 'createdAt', 'updatedAt' ],
  writable: [ 'displayName' ]
})(({ Grant, actors, all, grants, simply }) => class {
  ...
  grant(verbs, actee) {
    return all.do(ensureArray(verbs).map((verb) =>
