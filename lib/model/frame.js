...
class Frame {
  ...
  static fromApi(data) {
    ...
    const result = {};
    for (const Aux of this.def.aux) result[Aux.to] = Aux.fromApi(data);
    return new this(primary)(result);
  }
  static fromData(data) { // if only js had macros.
    const primary = new this(pick(this.def.fields, data));
    const result = {};
    for (const Aux of this.def.aux) result[Aux.to] = Aux.fromData(data);
    return new this(primary)(result);
  }
  ...
  auxWith(x, y) {
    return new this.constructor(this,
      Object.assign({}, this[__aux], Object.assign(this[__aux][x], y)));
  }
