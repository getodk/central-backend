...
const ChildTrait = (ParentName, { // eslint-disable-line object-curly-newline
  parentName = ParentName.toLowerCase(),
  parentId = `${parentName}Id`
} = {}) => (container) => { // eslint-disable-line object-curly-newline
  ...
  return class {
    ...
    forApi() {
      const ownReadable = pick(this.constructor.fields.readable, this);
      return (this[parentName] == null) ? ownReadable : merge(this[parentName].forApi(), ownReadable);
    }
