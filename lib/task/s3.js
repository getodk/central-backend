...
/**
 * Uploads pending blobs to S3 using the existing server DB connection.
 *
 ...
 * @param {Object} container.Blobs - Blob db model.
...
/**
 * CLI-compatible wrapper that sets up its own database connection (container)
