...
module.exports = (container) => {
  ...
  const { versionParser, sessionParser, fieldKeyParser, headerOptionsParser, containerInjector } = require('./middleware');
  ...
  service.use(containerInjector(container));


  ////////////////////////////////////////////////////////////////////////////////
  // RESOURCES

  require('../resources/field-keys')(service);
  require('../resources/odata')(service);
  require('../resources/forms')(service);
  require('../resources/users')(service);
  require('../resources/sessions')(service);
  require('../resources/submissions')(service);
  require('../resources/config')(service);
