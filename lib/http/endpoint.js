...
const streamErrorHandler = (response) => err => {
  console.log('streamErrorHandler()', err);
  console.log('streamErrorHandler()', 'response.headersSent:', response.headersSent);
  console.log('streamErrorHandler()', 'response.get(Content-Type):', response.get('Content-Type'));
  console.log('streamErrorHandler()', 'isJson', isJsonType(response.get('Content-Type')));
  console.log('streamErrorHandler()', 'err.streamNotStarted', err.streamNotStarted);
  console.log('streamErrorHandler()', 'err.isProblem', err.isProblem);
  if(err?.isProblem && err.streamNotStarted && !response.headersSent && isJsonType(response.get('Content-Type'))) {
