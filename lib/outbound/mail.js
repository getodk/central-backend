...
const messages = {
  ...
  backupFailed: message('ODK Central backup failed', '<html>Hello:<p>This is an automated system message to the listed ODK Central system administrator. ODK Central just attempted to perform a backup, but was unable to. Please visit the administration website and navigate to the Backups settings page for more information.</p></html>')
};
