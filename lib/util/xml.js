...
const findAndTraverse = (node, tagname) => (node == null) ? null : node.child.find((child) => child.tagname === tagname);

const traverseFirstChild = (node) => node.child[0];

module.exports = { standardOptions, toTraversable, findAndTraverse, traverseFirstChild };
