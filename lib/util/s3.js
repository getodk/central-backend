...
function urlForObject(objectName) {
  // content-type header could be overriden here if blob de-duplication with
  // different content-types is fixed.
  // See: https://min.io/docs/minio/linux/developers/javascript/API.html#presignedGetObject
  // See: https://github.com/getodk/central-backend/pull/1073
