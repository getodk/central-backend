...
const specificFields = (F, ...fields) =>
  class FilteredFrame extends F {
    constructor(...args) {
      return new F(...args); // eslint-disable-line no-constructor-return
    }

    static get fields() {
      return super.fields.filter(f => fields.includes(f));
    }
  };
...
module.exports = {
  ...
  QueryOptions,
  postgresErrorToProblem, specificFields,
};
