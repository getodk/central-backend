...
class Redirect { constructor(to) { this.to = to; } }
const redirect = (to) => { throw new Redirect(to); };
...
const urlWithQueryParams = (urlStr, set = {}) => {
  const obj = new URL(urlStr, 'http://opendatakit.org');
...
module.exports = {
  ...
  serialize,
  success, contentType, xml, atom, json, binary, redirect,
