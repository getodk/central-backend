...
const messages = {
  ...
  'account-created': message('Data collection account created', '<html>Hello!<p>An account has been provisioned for you on an Open Data Kit Effective Spork data collection server.</p><p>If this message is unexpected, simply ignore it. Otherwise, please visit the following link to set your password and claim your account:</p><p>https://{{domain}}/account/claim?token={{token}}</p></html>')
};
