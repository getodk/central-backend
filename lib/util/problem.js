...
const problems = {
  user: {
    ...
    // tried to create a draft when one already existed.
    draftAlreadyExists: problem(409.6, () => 'Could not create a new draft for this form, because one already exists. Please delete the draft before creating a new one.')
  },
  internal: {
