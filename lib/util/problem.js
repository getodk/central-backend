...
const problems = {
  ...
  internal: {
    ...
    // returned in case no central ODK analyticsEnketo service is configured.
    analyticsNotConfigured: problem(501.8, () => 'This ODK Central is missing its analytics configuration'),
