...
const problems = {
  user: {
    ...
    formRestoreWarnings: problem(400.44, () => 'The Form can be restored, but there are warning(s). Please check the warnings and if they are acceptable resubmit with ?ignoreWarnings=true'),
