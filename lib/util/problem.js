...
const problems = {
  user: {
    ...
    formDependentOnTheDataset: problem(409.21, () => `You can't delete this dataset because there are Form(s) dependent on it`),

    formDependentOnTheProperty: problem(409.22, () => `You can't delete this property because there are Form(s) writing to it`),

    dataExistsForTheProperty: problem(409.23, ({ propertyName }) => `You can't delete this property because there are Entity(ies) with the non-empty value for the '${propertyName}'`),
  },
  internal: {
