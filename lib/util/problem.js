...
const problems = {
  user: {
    ...
    // 400.6 (uniquenessViolation), was used in the past, but has been deprecated
    ...
    unexpectedAttributes: problem(400.30, ({ expected, actual }) => `Expected parameters: (${expected.join(', ')}). Got (${actual.join(', ')}).`),
