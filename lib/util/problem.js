...
const problems = {
  user: {
    ...
    // { field: "the name of the missing field }
    propertyNotFound: problem(400.22, ({ field }) => `Could not find a property named '${field}'`),

    // { field: "the name of the repeating field }
    unsupportedODataSelectField: problem(400.23, ({ field }) => `The given OData select property '${field}' uses features not supported by this server.`),
