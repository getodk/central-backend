...
// TEMP/SL: initialize our slonik connection pool.
const { createPool } = require('slonik');
const pool = createPool('postgres://jubilant:jubilant@localhost/jubilant');
...
const container = require('../model/package').withDefaults({ db, pool, mail, env, google, Sentry, password, xlsform, enketo });
