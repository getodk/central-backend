...
(async () => {
  ...
  await dbmain.raw('ALTER USER jubilant CREATEDB');
  await dbmain.raw('ALTER ROLE jubilant SUPERUSER'); // FIXME should not be necessary TODO probably USER/ROLE interchangeable?
