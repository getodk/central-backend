...
const extractFields = (fields, table, submission, options = {}) => new Promise((resolve) => {
    ...
    onopentag: (fullname) => {
      ...
      if ((fieldPtr != null) && (fieldPtr.children[name] != null)) {
        ...
        if (field.type === 'structure') {
          ...
          dataPtr[`${name}@odata.navigationLink`] = navigationLink(fieldStack, iterationStack);
      ...
      if ((fieldPtr != null) && (fieldPtr.name != null)) {
        if (getBranchState(fieldStack, table) === 1) {
          ...
          if (fieldPtr.type === 'int') {
            ...
            if (!Number.isNaN(altitude)) coordinates.push(altitude);
