...
const { stripNamespacesFromPath, traverseXml, findOne, findAll, root, node, tree, attr } = require('../util/xml');
...
module.exports = { getFormSchema, flattenSchemaStructures, getSchemaTables, schemaAsLookup, stripNamespacesFromSchema };
