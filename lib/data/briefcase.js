...
const streamBriefcaseCsvs = (inStream, inFields, xmlFormId, decryptor, rootOnly = false) => {
    ...
    transform(submission, _, done) {
      try {
        ...
        const xml =
          ...
          decryptor(encryption.encData, encryption.encKeyId, submission.localKey, submission.instanceId, encryption.encIndex); // eslint-disable-line indent
