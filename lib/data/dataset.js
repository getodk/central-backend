...
const matchFieldsWithDatasets = (datasets, fields) => {
  ...
  for (const field of fields) {
    ...
    if (exactMatch != null) {
      ...
      // Only look at potential property fields from save_tos
      ...
      if (matchedPath != null) {
        if (matchedRepeatPath != null && matchedRepeatPath.length > matchedPath.length) {
          // Property is in a repeat group but that repeat group is outside the closest dataset
