...
// n.b. this wants only selectMany fields!
const getSelectManyResponses = (selectManyFields, xml) => new Promise((resolve, reject) => {
  const values = {};
  const stream = submissionXmlToFieldStream(selectManyFields, xml);
...
module.exports = { submissionXmlToFieldStream, getSelectManyResponses, _hashedTree, _diffObj, _diffArray, diffSubmissions, _symbols: { subhash, subhashes, keys, score } };
